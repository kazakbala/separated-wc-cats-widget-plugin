<?php
/**
 * Plugin Name:    Separated by Parent Product Categories Widget for WooCommerce
...
if ( ! class_exists( 'WC_Widget' ) ) {
	...
	require_once  plugin_dir_path(__DIR__).'woocommerce/includes/abstracts/abstract-wc-widget.php';
}
...
class WC_SeparatedByParent_Widget_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'wc_separated_categories';
		$this->widget_name        = 'Separated by Parent Product Categories';
	...
	public function widget( $args, $instance ) {
		...
		$parent             = isset( $instance['parent'] ) ? $instance['parent'] : $this->settings['parent']['std'];
	...
	public function form( $instance ) {
		...
		foreach ( $categories as $category ) {
			$parentCategoryList[ $category->term_id ] = $category->name;
		}
		$this->settings['parent']['options'] = $parentCategoryList;
...
function WC_SeparatedByParent_Widget_Product_Categories() {
	register_widget( 'WC_SeparatedByParent_Widget_Product_Categories' );
}

add_action( 'widgets_init', 'WC_SeparatedByParent_Widget_Product_Categories' );
